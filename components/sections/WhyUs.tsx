...
const WhyUs = () => {
  return (
    <section className="py-16 px-4 lg:px-0">
      {/* Heading  */}
      <h1 className='font-dm-sans font-bold text-center text-[34px] mt-32 lg:mt-0 lg:text-[56px] my-8 ' data-aos="fade-up" data-aos-delay="100">Why Choose <span className="text-[#5D26FF]">Looprail?</span> </h1>

      {/* subheading  */}
      <p className="font-fustat text-gray-700 -mt-2 mb-8 text-center mx-auto text-[16px] lg:text-[22px] lg:w-[50%]" data-aos="fade-up" data-aos-delay="200">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto mt-12">
        {/* card 1 */}
        <div className="flex flex-col lg:text-left text-center" data-aos="fade-up" data-aos-delay="300">
        ...
        {/* card 2 */}
        <div className="flex flex-col lg:text-left text-center" data-aos="fade-up" data-aos-delay="400">
        ...
        {/* card 3 */}
        <div className="flex flex-col lg:text-left text-center" data-aos="fade-up" data-aos-delay="500">
        ...
        {/* card 4 */}
        <div className="flex flex-col lg:text-left text-center" data-aos="fade-up" data-aos-delay="600">
