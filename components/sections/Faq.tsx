...
const Faq = () => {
  ...
  const faqs = [
    {
      ...
      answer:
        "Looprail uses stablecoin technology to send money across borders instantly. Fund your wallet using a debit or credit card, google pay, apple pay or transfer from your bank account, enter the amount to send, and your recipient receives Nigerian Naira or stablecoins within minutes.",
    },
    {
      question: "Do I need a crypto wallet?",
      answer:
        "Looprail uses stablecoins like USDC and USDT to enable instant, transparent transfers across borders. You can send money directly to friends, family, or merchants in Africa without traditional banking delays.",
    },
    {
  ...
  return (
    <div className="py-16 px-4 lg:px-0">
      <h1
        className="font-dm-sans font-bold leading-10 lg:leading-16 text-[36px] lg:text-[56px] mt-8 text-center"
        data-aos="fade-up"
        data-aos-delay="100"
      >
      ...
      <p
        className="font-fustat text-[16px] lg:text-[23px] text-center mt-2 mb-16"
        data-aos="fade-up"
        data-aos-delay="200"
      >
