...
const HowItWorks = () => {
  return (
    <section className='py-16 px-3 lg:px-0'>
      {/* Heading  */}
      <h1 className='font-dm-sans font-bold text-[34px] lg:text-[56px] my-8 '>How <span className="text-[#5D26FF]">Looprail</span> Works</h1>

      {/* Bento grid  */}
      <div className="grid grid-cols-1 lg:grid-cols-12 w-full gap-6  px-3 lg:px-0">
        <div className="lg:col-span-5 w-full bg-[#F7F7F7] px-6 pt-6 rounded-2xl">
        ...
        <div className="lg:col-span-7 gap-5 items-start justify-start ">
          <div className="row-span-6 flex flex-col w-auto bg-[#5D26FF] rounded-2xl text-white overflow-hidden font-fustat h-[57%] relative p-6">
            <Image
          ...
          <div className="row-span-4 w-full mt-6 bg-[#F7F7F7] px-6 pt-6 rounded-2xl overflow-hidden relative lg:h-[40%] h-[65%]">
